            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair4.jpg" alt="Chair1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork Medium Back Office Chair (Black & Brown)</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair5.jpeg" alt="chair2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> WoodWork Office Chair medium back (Brown)</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair6.jpg" alt="chair3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork Medium back office chair (black)</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair7.jpeg" alt="Chair">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork Medium back office chair (white)</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair8.jpg" alt="chair">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork chair #301</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair9.jpg" alt="chair">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork chair #302</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair10.jpg" alt="chair">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork chair #303</h3>
                                    <p>Price: Rs. 8000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chair11.jpg" alt="chair">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork chair #304</h3>

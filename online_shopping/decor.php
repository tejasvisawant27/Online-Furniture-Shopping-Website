            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor1.jpeg" alt="decor1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #401</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor2.jpeg" alt="decor2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> WoodWork decor #402</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor3.jpeg" alt="decor3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #403</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor4.jpg" alt="decor4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #404</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor5.png" alt="decor5">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #405</h3>
                                    <p>Price: Rs. 1350.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor6.jpg" alt="decor6">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #406</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor7.png" alt="decor7">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #407</h3>
                                    <p>Price: Rs. 6750.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor8.jpeg" alt="decor">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #408</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/decor.jpg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>WoodWork decor #409</h3>
